...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser: CommandParser) -> None:
        parser.add_argument('--max_vehicle_count', type=int, help='The number of vehicles to use for the delivery routes.')
    ...
    def handle(self, *args, **options):
        ...
        max_vehicle_count = options['max_vehicle_count']
        vehicle_count = min(max_vehicle_count, Vehicle.objects.filter(status='free').count())
